...
function loadHTMLTable(data) {
    ...
    data.forEach(({ year, start_date, end_date,team, primary_call, secondary_call}) => {
        ...
        tableHTML += `<td><div>${primary_call}</div><div style="display:none"><input type ="text"><button class= 'modify-col-p-btn' data-year=${year} data-start_date=${start_date} data-end_date=${end_date} data-team = ${team}>Modify</button></div></td>`;
        tableHTML += `<td><div>${secondary_call}</div><div style="display:none"><input type ="text"><button class= 'modify-col-s-btn' data-year=${year} data-start_date=${start_date} data-end_date=${end_date} data-team = ${team}>Modify</button></div></td>`;
